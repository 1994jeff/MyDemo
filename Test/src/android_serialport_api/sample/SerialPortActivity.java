...
public abstract class SerialPortActivity extends Activity {
	...
	public class ReadThread extends Thread {
		...
		public void run() {
			...
			Log.i("dengjifu", "ReadThread/isInterrupted():" + isInterrupted());
			while(!isInterrupted()) {
				try {
...
//		        		mInputStream.read(buffer, 0, length);
...
//				}
	...
	protected void onDestroy() {
		...
		mSerialPort = null;
//		FileUtils.writeFile("/sys/devices/platform/ptt_a1852/ptt_a1852", "0xfe");
		super.onDestroy();
	}
}
